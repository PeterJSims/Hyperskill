...
public class NumberClassifier {
    ...
    public static boolean isJumping(long n) {
        ...
        for (int i = 1; i < numString.length(); i++) {
            int leftInt = Integer.valueOf(String.valueOf(numString.charAt(i - 1)));
            int rightInt = Integer.valueOf(String.valueOf(numString.charAt(i)));
            if (Math.abs(leftInt - rightInt) != 1) return false;
        }
        return true;
    }
