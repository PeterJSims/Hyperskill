...
class Board:
    ...
    def determine_moves(self):
        ...
        for move in Board.MOVES:
            row_spot = self.current_position[0] - move[0]
            column_spot = self.current_position[1] - move[1]
    ...
    def mark_spots(self, possible_spots: list[tuple]):
        for spot in possible_spots:
            self.mark_position(spot[0], spot[1], 'O')
...
if __name__ == '__main__':
    game = BoardInterface()
    game.main()
# TODO iterate through moves, filter to which are possible
# Feed these moves to marker
# Keep a running list of possible spots?
